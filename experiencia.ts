export const experiencia = [
  {
    Name: "Desenvolvendome (Mentoria)",
    Descricao:
      "Nossa equipe tem oportunidade de adquirir e aperfeiçoar habilidades Hard Skills, Soft Skills, Mindset e Inteligência Emocional",
    "Soft skills": [
      "Comunicação",
      "Colaboração",
      "Disciplina",
  ...
  {
    Name: "Sygecom (Estágio)",
    Descricao:
      "Auxiliar no Desenvolvimento de atividades utilizando Figma e contribuindo com novas ideias relacionadas ao projeto, utilizando front-end com React-native seguindo o protótipo back-end com nodeJs, modelagem de dados e banco de dados com PostgreSQL",
    "Soft skills": [
      "Comunicação",
      "Colaboração",
      "Disciplina",
